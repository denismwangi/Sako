...
class AccountAdapters(var context: Context, var arrayList: ArrayList<AccountList>): BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
       val view:View = View.inflate(context , R.layout.account_cardview, null)
